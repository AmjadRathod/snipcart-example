...
$(document).ready(function(){
  ...
  Snipcart.subscribe('page.changed', function (page) {
    ...
    if (page == 'cart-content') {
      // Snipcart.settings.onlyAllowGuests = false;
      $("#snipcart-discounts .snip-actions").append('<div id="snipcart-current-user-login"><div class="snip-header__user signup"><a href="#" class="snipcart-user-profile"><span class="accordion">I&#39;M MEMBER</span></a></div></div><div class="panel"><input type="text" name="email" id="snipcart-login-email"><input type="password" name="password" id="snipcart-login-password"><a href="#" id="snipcart-login-forgotpassword-link"class="snip-static__link">I forgot my password</a><a href="#" id="snipcart-login-submit" class="snip-btn snip-btn--full">Login</a></div>');
      var acc = $(".accordion");
      var i;
