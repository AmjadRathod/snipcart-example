...
$(document).ready(function(){
  ...
  Snipcart.subscribe('page.changed', function (page) {
    ...
    if (page == 'cart-content') {
      ...
      $("#snipcart-discounts .snip-actions").append('<div id="snipcart-current-user-login"><div class="snip-header__user signup"><a href="#" class="js-next"><span class="snipcart-user-email">I&#39;M MEMBER</span></a></div></div>');
      $(".snip-header__user").append('<a href="#" class="snipcart-user-logout">(logout/change)</a>');
